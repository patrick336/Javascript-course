...
var starButton = document.getElementById('js-start');
starButton.addEventListener('click', function () {
  return stopwatch.start();
});

var stopButton = document.getElementById('js-stop');
...
deleteButton.addEventListener('click', function () {
  return stopwatch.deleteTimes();
});

var resetButton = document.getElementById('js-reset');
resetButton.addEventListener('click', function () {
  return stopwatch.resetActualTimer();
});
